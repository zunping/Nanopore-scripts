...
def read_infile(infile):
	'''
	opens an input file. reads and stores all lines. returns as a list
	'''
	input_file = open(infile,'r')
	lines = input_file.readlines()
	input_file.close()
	#return a list that contains all lines	
	return lines	

def get_max_depth(lines):
	'''
	returns the maximum depth for all snps(TP/FP) from .accuracy.txt
	'''
